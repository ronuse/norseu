...
import { PopupPage } from './components/core/overlay/PopupPage'
                ...
                <LinearLayout style={{flex: 1, maxHeight: "93%"}}>
                    <Navbar noOverlay position={Position.LEFT} isVisible={true} className="left-sidebar">
                        <ScrollPanel>
                            ...
                            <section>
                                ...
                                <Link className="link" to="/core/overlay/popup">Popup</Link>
                            </section>
                    ...
                    <ScrollPanel style={{flex: 1, height: "100%"}} ref={componentDocumentationPanel}>
                        <Switch>
                            ...
                            <Route exact path="/core/overlay/popup" component={PopupPage}/>
